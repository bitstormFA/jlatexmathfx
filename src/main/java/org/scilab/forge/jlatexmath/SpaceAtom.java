...
public class SpaceAtom extends Atom {
    ...
    public SpaceAtom(int widthUnit, double width, int heightUnit, double height,
                     int depthUnit, double depth) throws InvalidUnitException {
    ...
    public static double[] getLength(String lgth) {
        ...
        return new double[]{(double) unit, f};
    }
