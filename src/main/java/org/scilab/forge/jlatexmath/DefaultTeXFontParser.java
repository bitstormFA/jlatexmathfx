...
public class DefaultTeXFontParser {
    ...
    private static class KernParser implements CharChildParser {
        ...
        public void parse(Element el, char ch, FontInfo info) throws ResourceParseException {
            ...
            double kernAmount = DefaultTeXFontParser.getDoubleAndCheck("val", el);
    ...
    public FontInfo[] parseFontDescriptions(FontInfo[] fi, InputStream file, String name) throws ResourceParseException {
        ...
        double space = getDoubleAndCheck("space", font);
        double xHeight = getDoubleAndCheck("xHeight", font);
        double quad = getDoubleAndCheck("quad", font);
    ...
    private static void processCharElement(Element charElement, FontInfo info)
        ...
        metrics[DefaultTeXFont.WIDTH] = getOptionaldouble("width", charElement, 0);
        metrics[DefaultTeXFont.HEIGHT] = getOptionaldouble("height", charElement, 0);
        metrics[DefaultTeXFont.DEPTH] = getOptionaldouble("depth", charElement, 0);
        metrics[DefaultTeXFont.IT] = getOptionaldouble("italic", charElement, 0);
        // set metrics
    ...
    public static Font createFont(InputStream fontIn, String name) throws ResourceParseException {
        try {
            Font f = Font.loadFont(fontIn, 12.0);
    ...
    public Map<String, Double> parseParameters() throws ResourceParseException {
        ...
        if (parameters == null)
            ...
            for (int i = 0; i < list.getLength(); i++) {
                ...
                res.put(name, new Double(getDoubleAndCheck(name, parameters)));
            }
            return res;
        }
    }
    ...
    public Map<String, Number> parseGeneralSettings() throws ResourceParseException {
        ...
        if (generalSettings == null)
            ...
            res.put("scriptfactor", getDoubleAndCheck("scriptfactor",
                    generalSettings)); // autoboxing
            res.put("scriptscriptfactor", getDoubleAndCheck(
    ...
    public static double getDoubleAndCheck(String attrName, Element element)
            throws ResourceParseException {
        ...
        double res = 0;
        try {
            res = (double) Double.parseDouble(attrValue);
    ...
    public static double getOptionaldouble(String attrName, Element element,
        ...
        if (attrValue.equals("")) // attribute not present
            ...
            try {
                ...
                throw new XMLResourceParseException(RESOURCE_NAME, element
                        .getTagName(), attrName, "has an invalid double value!");
            }
            // parsing OK
            return res;
        }
