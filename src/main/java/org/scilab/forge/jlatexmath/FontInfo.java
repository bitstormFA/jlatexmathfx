...
public class FontInfo {
    ...
    public FontInfo(int fontId, Object base, String path, String fontName, int unicode, double xHeight, double space, double quad, String boldVersion, String romanVersion, String ssVersion, String ttVersion, String itVersion) {
        this.fontId = fontId;
        this.base = base;
        this.path = path;
