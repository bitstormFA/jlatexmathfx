...
public class FractionAtom extends Atom {
     ...
     */
    public FractionAtom(Atom num, Atom den, boolean noDef, int unit, double t)
     ...
     * @param denomAlign alignment of the denominator
     */
    public FractionAtom(Atom num, Atom den, double defFactor, int numAlign,
                        int denomAlign) {
     ...
     * @param denomAlign alignment of the denominator
     */
    public FractionAtom(Atom num, Atom den, int unit, double t, int numAlign,
                        int denomAlign) {
        this(num, den, unit, t);
        this.numAlign = checkAlignment(numAlign);
        this.denomAlign = checkAlignment(denomAlign);
    ...
    public Box createBox(TeXEnvironment env) {
        ...
        if (thickness > 0) { // WITH fraction rule
            ...
            delta = thickness / 2;
            double kern1 = shiftUp - num.getDepth() - (axis + delta), kern2 = axis
