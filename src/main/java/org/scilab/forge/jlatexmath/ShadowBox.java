...
public class ShadowBox extends FramedBox {
    ...
    public void draw(GraphicsContext g2, double x, double y) {
        ...
        g2.strokeRect(x + th, y - height + th, width - shadowRule - thickness, height + depth - shadowRule - thickness);
        double penth = (double) Math.abs(1 / g2.getTransform().getMxx());
        g2.setLineWidth(penth);
        g2.fillRect(x + shadowRule - penth, y + depth - shadowRule - penth, width - shadowRule, shadowRule);
        g2.fillRect(x + width - shadowRule - penth, y - height + th + shadowRule, shadowRule, depth + height - 2 * shadowRule - th);
        g2.restore();
    }
